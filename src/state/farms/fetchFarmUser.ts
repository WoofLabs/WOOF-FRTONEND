...
export const fetchFarmUserAllowancesNew = async (
  account: string,
  farmsToFetch: SerializedFarmConfig[],
  chainId: number,
  proxyAddress?: string,
) => {
  const masterChefAddress = getMasterChefAddressNew(chainId)
...
export const fetchFarmUserTokenBalancesNew = async (
  account: string,
  farmsToFetch: SerializedFarmConfig[],
  chainId: number,
) => {
...
export const fetchFarmUserStakedBalancesNew = async (
  account: string,
  farmsToFetch: SerializedFarmConfig[],
  chainId: number,
) => {
...
export const fetchFarmUserEarningsNew = async (account: string, farmsToFetch: SerializedFarmConfig[], chainId: number) => {
  const isBscNetwork = verifyBscNetwork(chainId)
  const multiCallChainId = isBscNetwork ? chainId : await getBscChainId(chainId)
  const masterChefAddress = getMasterChefAddressNew(multiCallChainId)
